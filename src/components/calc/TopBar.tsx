...
import { Calculator, FlaskConical, ArrowLeftRight, Sun, Moon, History as HistoryIcon, Settings as SettingsIcon } from "lucide-react";
...
export function TopBar({ onOpenHistory, onOpenSettings }: TopBarProps) {
  ...
  return (
    <header className="safe-top px-3 pt-3 pb-2">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 min-w-0">
          <button
            ...
            className="inline-flex items-center justify-center rounded-full h-10 w-10 bg-muted/60 text-foreground hover:bg-foreground/5 transition-colors no-tap-highlight shrink-0"
          >
